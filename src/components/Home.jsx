...
const Home = () => {
  ...
  <section className="mx-auto mt-16 pt-24 pb-28 relative max-w-screen-2xl p-4 isolate">
    ...
    >
{/* <circle cx="250" cy="450" r="180" fill="#FFD700" /> */}
    ...
    <div className="mx-auto max-w-2xl">
      <p className="text-center font-medium tracking-wide uppercase font-bold"  style={{ color: '#d4ac0d'}}>Smart Trading</p>
      <p className="mt-2 text-center text-4xl md:text-6xl font-bold tracking-tight text-black">
      Boost & Profit from Your Demo Trading      </p>
      <p className="mt-6 text-lg text-gray-600 text-center">
      Sharpen your trading skills on our FTMO demo platform—access up to $200,000 in virtual funds and claim up to 90% of your simulated profits!        </p>
      ...
      <div className="items-center justify-center mt-6 flex gap-3">
        ...
        Take the first step toward becoming a pro trader today!   </p>
      </div>
