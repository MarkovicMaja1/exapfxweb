              ...
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">Office 7330MO 182-184, High Street North Area 1/1</p>
                    <p className="text-gray-600 dark:text-slate-400">East Ham, London, E6 2JA, UK</p>
                  </div>
                </li>
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">Email: contact@ecapfx.com</p>
                  </div>
                </li>
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">Monday - Friday: 08:00 - 17:00 EST</p>
                    <p className="text-gray-600 dark:text-slate-400">Saturday & Sunday: 08:00 - 12:00 EST</p>
                  </div>
                </li>
              </ul>
            </div>
