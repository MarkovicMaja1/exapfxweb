...
const Footer = () => {
            ...
            <div className="flex justify-center mb-6">
              ...
              <div className="flex justify-center mb-6">
                <div className="md:order-2 flex space-x-6 justify-center ml-1 socialMediaPhone">
                  ...
                  {/* <a href="https://www.youtube.com" className="text-gray hover:text-white">
  ...
  <ul role="list" className="mt-6 space-y-4 ml-28 addInformations">
    ...
    <li>
      <small href="#somethingnew" className="text-sm leading-6 text-white hover:text-white">
</small>
    </li>
    <li>
      <small href="#team" className="text-sm leading-6 text-white hover:text-white">
</small>
    </li>
  </ul>
  ...
  <ul role="list" className="mt-6 space-y-4">
    ...
    <li>
      <small href="#chooseplan" className="text-sm leading-6 text-white hover:text-white">
</small>
    </li>
    {/* <li>
      <small href="#somethingnew" className="text-sm leading-6 text-white hover:text-white">London E6 2JA</small>
    </li> */}
