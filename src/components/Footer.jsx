        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8 paddingFooter">
          <div className="mt-10 xl:mt-0 additionalInfos">
            <div className="flex justify-center mb-6">
              <img src={logo} alt={t('footer.images.logo')} className="w-48 h-auto" />
            </div>
            <div className="flex justify-center mb-6">
              <div className="md:order-2 flex space-x-6 justify-center ml-1 socialMediaPhone">
                ...
                <a href="https://www.instagram.com/ecapfx/" className="text-gray hover:text-white">
          ...
          <div className="mt-10 xl:mt-0 xl:col-span-2 grid grid-cols-2 gap-8">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <p className="text-sm font-semibold leading-6 text-white">{t('footer.importantLinks.title')}</p>
                <ul role="list" className="mt-6 space-y-4">
                  {t('footer.importantLinks.items', { returnObjects: true }).map((item, index) => (
                    <li key={index}>
                      <small>
                        <Link to={item.to} className="text-sm leading-6 text-white hover:text-white">
                          {item.label}
                        </Link>
                      </small>
                    </li>
              ...
              <div className="mt-10 md:mt-0">
                <p className="text-sm font-semibold leading-6 text-white">{t('footer.ourServices.title')}</p>
                <ul role="list" className="mt-6 space-y-4">
                  {t('footer.ourServices.items', { returnObjects: true }).map((item, index) => (
                    <li key={index}>
                      <small>
                        <Link to={item.to} className="text-sm leading-6 text-white hover:text-white">
                          {item.label}
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <p className="text-sm font-semibold leading-6 text-white">{t('footer.customerCare.title')}</p>
                <ul role="list" className="mt-6 space-y-4">
                  {t('footer.customerCare.items', { returnObjects: true }).map((item, index) => (
                    <li key={index}>
                      <small>
                        <Link to={item.to} className="text-sm leading-6 text-white hover:text-white">
                          {item.label}
              ...
              <div className="mt-10 md:mt-0">
                <p className="text-sm font-semibold leading-6 text-white">{t('footer.policies.title')}</p>
                <ul role="list" className="mt-6 space-y-4">
                  {t('footer.policies.items', { returnObjects: true }).map((item, index) => (
                    <li key={index}>
                      <small>
                        <Link to={item.to} className="text-sm leading-6 text-white hover:text-white">
                          {item.label}
        ...
        <div className="footer-primary-row-3 mt-10">
          <div className="w-full flex flex-col items-center justify-center">
            ...
            <div className="footer-primary-payments-list flex flex-row flex-wrap justify-center items-center gap-4">
              <img src={visa} alt={t('footer.images.visa')} className="h-4 w-auto" />
              <img src={mastercard} alt={t('footer.images.mastercard')} className="h-5 w-auto" />
              <img src={paypal} alt={t('footer.images.paypal')} className="h-5 w-auto" />
              ...
              <a href="https://www.tradingview.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white">
