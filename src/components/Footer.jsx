            ...
            <div className="flex justify-center mb-6">
              ...
              <div className="flex justify-center mb-6">
                <div className="md:order-2 flex space-x-6 justify-center ml-1 socialMediaPhone">
                  <a href="https://www.facebook.com/people/Ecapfx/61575174327161/" className="text-gray-400 hover:text-white">
                  ...
                  <a href="https://x.com/EcapFXLTD" className="text-gray-400 hover:text-white">
                    <span className="sr-only">X</span>
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="">
                      <path d="M13.6823 10.6218L20.2391 3H18.6854L12.9921 9.61788L8.44486 3H3.2002L10.0765 13.0074L3.2002 21H4.75404L10.7663 14.0113L15.5685 21H20.8131L13.6819 10.6218H13.6823ZM11.5541 13.0956L10.8574 12.0991L5.31391 4.16971H7.70053L12.1742 10.5689L12.8709 11.5655L18.6861 19.8835H16.2995L11.5541 13.096V13.0956Z"></path>
                    </svg>
                  </a>
                  <a href="https://www.linkedin.com/company/ecapfx/" className="text-gray-400 hover:text-white">
                  ...
                  <a href="https://discord.gg/eBkRpp66" className="text-gray-400 hover:text-white">
          ...
          <div className="mt-10 xl:mt-0 xl:col-span-2 grid grid-cols-2 gap-8">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <small href="#" className="text-sm leading-6 text-gray-300 hover:text-white">Support Portal</small>
                  </li>
                  <li>
