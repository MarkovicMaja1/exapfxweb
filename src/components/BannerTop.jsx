...
const Header = () => {
  ...
  return (
    <>
      <div
        className="fixed top-0 left-0 w-full h-[67px] lg:h-[50px] px-5 sm:px-6 flex items-center justify-between z-[999]"
        style={{
      ...
      >
        ...
        <div className="flex-1 h-full w-full relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-fit" style={{ translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)' }}>
            <div>
              <div>
      ...
      <header className="bg-[#151515] fixed top-0 left-0 right-0 z-50 w-full mt-[67px] lg:mt-[50px]"
        style={{
