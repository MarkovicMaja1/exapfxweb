                  ...
                  >
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden h-full transition-transform duration-300 border-t-4 border-yellow-600 ">
                      ...
                      <h2 className="mt-4 text-xl font-bold text-gray-900 leading-tight">
                        ...
                        <h2 className="mt-2 text-xl font-bold leading-tight text-yellow-600">
                          {post.title}
                        </h2>
...
//       <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 mt-16 px-6 max-w-6xl mx-auto">
//         <div className="bg-white rounded-xl shadow-md p-6 w-full border-t-4 border-yellow-600 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
