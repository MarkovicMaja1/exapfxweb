...
const Cookies = () => {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-black-100 min-h-screen pt-24 pb-12">
      <h4 className="text-4xl text-center font-bold text-[#1d8348] mt-20 mb-10">{t('cookiePolicy.title')}</h4>
      ...
      <section className="mb-8">
        ...
        <p className="text-black-400">
          ...
          <a
            href={t('cookiePolicy.sections.introduction.website')}
      ...
      <section className="mb-8">
        ...
        <p className="text-black-400 mt-2">
          ...
          <a
            href={`mailto:${t('cookiePolicy.sections.operator.email')}`}
            className="text-[#1d8348] hover:text-[#f9e79f] underline"
          >
      ...
      <section className="mb-20">
        ...
        <p className="text-black-400 mt-2">
          ...
          <a
            href={t('cookiePolicy.sections.contact.website')}
            className="text-[#1d8348] hover:text-[#f9e79f] underline"
            target="_blank"
            rel="noopener noreferrer"
          >
