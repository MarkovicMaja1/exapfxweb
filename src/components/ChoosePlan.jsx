...
const ChoosePlan = () => {
  return (
    <div className="funding-journey-container">
      {/* Divider Section */}
      <div className="py-2 bg-[#151515] dark:bg-opacity-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {/* Provided Elementor Code with Tailwind Classes */}
            <div className="flex flex-col items-center justify-center p-4 rounded-lg shadow-md border border-green-500">
              <div className="elementor-icon-box-icon">
                <span className="elementor-icon">
                  {/* Forex SVG content */}
                  {/* (Paste the Forex SVG path and related content here) */}
                </span>
              </div>
            ...
            <div className="flex flex-col items-center justify-center p-4 rounded-lg shadow-md border border-green-500">
              <div className="elementor-icon-box-icon">
                <span className="elementor-icon">
                  {/* Metals SVG content */}
                  {/* (Paste the Metals SVG path and related content here) */}
                </span>
              </div>
              <div className="elementor-icon-box-content">
                <h5 className="text-lg font-semibold text-gray-900 dark:text-white text-center">
            ...
            <div className="flex flex-col items-center justify-center p-4 rounded-lg shadow-md border border-green-500">
              <div className="elementor-icon-box-icon">
                <span className="elementor-icon">
                  {/* Indices SVG content */}
                  {/* (Paste the Indices SVG path and related content here) */}
                </span>
              </div>
              <div className="elementor-icon-box-content">
                <h5 className="text-lg font-semibold text-gray-900 dark:text-white text-center">
            ...
            <div className="flex flex-col items-center justify-center p-4 rounded-lg shadow-md border border-green-500">
              <div className="elementor-icon-box-icon">
                <span className="elementor-icon">
                  {/* Commodities SVG content */}
                  {/* (Paste the Commodities SVG path and related content here) */}
                </span>
              </div>
              <div className="elementor-icon-box-content">
                <h5 className="text-lg font-semibold text-gray-900 dark:text-white text-center">
            ...
            <div className="flex flex-col items-center justify-center p-4 rounded-lg shadow-md border border-green-500">
              <div className="elementor-icon-box-icon">
                <span className="elementor-icon">
                  {/* Crypto SVG content */}
                  {/* (Paste the Crypto SVG path and related content here) */}
                </span>
              </div>
              <div className="elementor-icon-box-content">
                <h5 className="text-lg font-semibold text-gray-900 dark:text-white text-center">
            ...
            <div className="flex flex-col items-center justify-center p-4 rounded-lg shadow-md border border-green-500">
              <div className="elementor-icon-box-icon">
                <a
                  href="https://tradethepool.com/"
                  className="elementor-icon"
                  aria-label="Stocks"
                >
                  {/* Stocks SVG content */}
                  {/* (Paste the Stocks SVG path and related content here) */}
                </a>
              </div>
              <div className="elementor-icon-box-content">
                <h5 className="text-lg font-semibold text-gray-900 dark:text-white text-center">
                  <a href="https://tradethepool.com/">Stocks</a>
                </h5>
              </div>
            </div>
          </div>
